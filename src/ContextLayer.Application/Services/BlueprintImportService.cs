    ...
    : IBlueprintImportService
{
    ...
    public async Task<BlueprintImportResult> UploadAsync(UploadBlueprintInput input, CancellationToken cancellationToken)
    {
        ...
        var blueprintName = TryReadString(input.BlueprintJson, "name") ?? input.Name ?? "Context Layer Blueprint";
    ...
    public const string SchemaJson = """
        {
          ...
          "$id": "https://universalcontextlayer.dev/schemas/context-layer-blueprint.schema.json",
          "title": "ContextLayerBlueprint",
          "type": "object",
