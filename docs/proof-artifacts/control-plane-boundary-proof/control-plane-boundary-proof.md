...
- `docs\proof-artifacts\control-plane-boundary-proof\control-plane-boundary-proof.json`
- `docs\proof-artifacts\control-plane-boundary-proof\control-plane-boundary-proof.md`
- `docs\proof-artifacts\control-plane-boundary-proof\accepted-control-plane-records.jsonl`
- `docs\proof-artifacts\control-plane-boundary-proof\accepted-control-plane-records.csv`
- `docs\proof-artifacts\control-plane-boundary-proof\forbidden-payload-results.json`
