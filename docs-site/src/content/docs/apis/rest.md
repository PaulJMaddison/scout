...
| `POST` | `/api/v1/intelligence/next-action` | `context:read` | Generate exact linked records, relationships, Scout fallback/demo weighted signals, and a recommended next action. |
