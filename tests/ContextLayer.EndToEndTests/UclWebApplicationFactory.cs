...
/// </summary>
internal sealed class UclWebApplicationFactory : WebApplicationFactory<Program>
{
    private const string TestSigningKey = "context-layer-tests-signing-key-1234567890";
    private const string TestIssuer = "ContextLayer.Tests";
    private const string TestAudience = "ContextLayer.Tests";
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureServices(services =>
        {
            var dbDescriptors = services
                .Where(d =>
                    ...
                    (d.ServiceType.FullName.Contains("DbContextOptions", StringComparison.Ordinal) ||
                     ...
                     d.ServiceType == typeof(ContextLayerDbContext) ||
                     d.ServiceType == typeof(CustomerOpsDbContext) ||
                     d.ServiceType == typeof(IContextLayerDbContext) ||
            ...
            services.AddScoped<IContextLayerDbContext>(provider =>
    ...
    public async Task SeedGoldenPathDataAsync()
    {
        ...
        var contextDb = scope.ServiceProvider.GetRequiredService<ContextLayerDbContext>();
