...
export function DataSourcesPage() {
  ...
  const initialConnectorAppliedRef = useRef(false)
  ...
  useEffect(() => {
    if (initialConnectorAppliedRef.current || !connectorPluginsQuery.data?.length) {
      return
    }
    ...
    form.reset(toFormValues(undefined, requestedPlugin))
    initialConnectorAppliedRef.current = true
  }, [connectorPluginsQuery.data, form])
