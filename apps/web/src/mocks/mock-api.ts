...
function buildMockNextAction(input: NextActionInput): NextActionResult {
  ...
  const packageId = 'EP-SYN-REL-001'
  const packageVersion = '2026-06-16.relationship-intelligence.v1'
  const appliedRules = [
  ...
  const cloudAggregateUsagePayload = {
    payloadKind: 'cloud-aggregate-usage',
    payloadVersion: '2026-06-16.cloud-aggregate-usage.v1',
    packageVersion,
  ...
  return {
    ...
    governance: {
      ...
      maskedFields,
      deniedFields: [],
      cloudAggregateUsagePayloadJson: prettyJson(cloudAggregateUsagePayload),
    },
    evidencePack: {
      evidencePackId: packageId,
      packageVersion,
      generatedAtUtc: isoNow(),
      localDerivedEvidencePackageJson: prettyJson(localPackage),
      cloudAggregateUsagePayloadJson: prettyJson(cloudAggregateUsagePayload),
      cloudPayloadContainsRawCustomerData: false,
    },
  }
